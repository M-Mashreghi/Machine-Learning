...
def main():
    train_data , train_label = loadImages(
        r"H:\GIT project\Machine Learning with Abolgasemi/5\Q5_Datasets\part1\emotion detection dateset\train")
    test_data , test_label = loadImages(
        r"H:\GIT project\Machine Learning with Abolgasemi/5\Q5_Datasets\part1\emotion detection dateset\test")
